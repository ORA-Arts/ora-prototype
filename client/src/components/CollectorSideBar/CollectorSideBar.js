...
const CollectorSideBar = (props) => {
    const enumPos = ["my-collector-profile", "my-acquisitions", "my-artists", "my-galleries", "my-collection", "my-content", "customer-support"];
    ...
    return (
        <div className="collector-sidebar text-left">
            <div className="sidebar-box">
                ...
                <div className={`collector-sidebar-text ${currentContent === enumPos[1] ? "sidebar-text-bold" : null }`}>MY ACQUISITIONS</div>
                <div className={`collector-sidebar-text ${currentContent === enumPos[2] ? "sidebar-text-bold" : null }`}><Link to={'/gallery/artists'}>MY ARTISTS</Link></div>
